  ...
  return (
    <div>
      <div className="relative h-screen bg-white overflow-hidden">
        ...
        <div className="absolute top-0 right-0 w-full h-full bg-red-600 z-0"
          style={{ clipPath: 'polygon(40% 0, 100% 0, 100% 100%, 60% 100%)' }}></div>
        <div className="relative z-10 p-10 md:p-20 max-w-3xl">
          ...
          <button className="mt-6 bg-red-600 text-white px-6 py-3 rounded hover:bg-red-700 transition cursor-pointer">
            Discover Now
          </button>
        </div>
      </div>
